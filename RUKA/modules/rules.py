...
from RUKA.modules.helper_funcs.decorators import VERMEILCMD
from RUKA.modules.helper_funcs.anonymous import user_admin, AdminPerms


@VERMEILCMD(command='rules', filters=Filters.chat_type.groups)
...
@VERMEILCMD(command='setrules', filters=Filters.chat_type.groups)
...
@VERMEILCMD(command='clearrules', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
